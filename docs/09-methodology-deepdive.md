...
> For the Blomstra-wide research standards that govern how ALL indices measure things, see [`10-engineering-research-standards.md`](10-engineering-research-standards.md).
> For the generalized partial-coverage algorithm that works for any N-pillar index, see BMS-002 in that document.
...
- The generalized standards → [`10-engineering-research-standards.md`](10-engineering-research-standards.md)
